...
<Box display="flex" justifyContent={"center"}  w="100%" gap="5px" alignItems={"center"}><AiFillLinkedin   fontSize={"40px"} cursor="pointer" onClick={()=>{window.open("https://www.linkedin.com/in/akash-singha-b62992213/","_blank")}}/><Text onClick={()=>{window.open("https://www.linkedin.com/in/akash-singha-b62992213/","_blank")}} id="contact-linkedin" color="#8993b1" cursor={"pointer"}>@akash-singha-b62992213</Text></Box>
 ...
 <Box display="flex" justifyContent={"center"}  w="100%" gap="5px" alignItems={"center"}><AiOutlineMail    fontSize={"40px"} cursor="pointer" onClick={()=>{window.open("mailto:akashsingha3558@gmail.com","_blank")}}/>  <Text onClick={()=>{window.open("mailto:akashsingha3558@gmail.com","_blank")}} color="#8993b1" cursor={"pointer"} id="contact-email">akashsingha3558@gmail.com</Text></Box>
      ...
      <Box display="flex" width={"100%"} flexWrap="wrap" justifyContent="center" margin="auto" alignItems={"center"} gap="10px" mt="20px" >
        <Box display="flex" justifyContent={"center"} alignItems="center" gap="5px"><AiOutlinePhone fontSize={"30px"} cursor="pointer" onClick={() => { window.open("tel:123-456-7890", "_blank") }} />  <Text id="contact-phone" color="#8993b1">8918751633</Text></Box>
        <Box display="flex" justifyContent={"center"} alignItems="center" gap="5px">< AiFillGithub fontSize={"30px"} cursor="pointer" onClick={() => { window.open("https://github.com/akash-singha-3558", "_blank") }} /><Text onClick={() => { window.open("https://github.com/akash-singha-3558", "_blank") }} color="#8993b1" id="contact-github" cursor={"pointer"}>@akash-singha-3558</Text></Box>
        <Box display="flex" justifyContent={"center"} alignItems="center" gap="5px"><AiFillLinkedin fontSize={"30px"} cursor="pointer" onClick={() => { window.open("https://www.linkedin.com/in/akash-singha-b62992213/", "_blank") }} /><Text onClick={() => { window.open("https://www.linkedin.com/in/akash-singha-b62992213/", "_blank") }} id="contact-linkedin" color="#8993b1" cursor={"pointer"}>@akash-singha-b62992213</Text></Box>
        <Box display="flex" justifyContent={"center"} alignItems="center" gap="5px"><AiOutlineMail fontSize={"30px"} cursor="pointer" onClick={() => { window.open("mailto:akashsingha3558@gmail.com", "_blank") }} />  <Text onClick={() => { window.open("mailto:akashsingha3558@gmail.com", "_blank") }} color="#8993b1" cursor={"pointer"} id="contact-email">akashsingha3558@gmail.com</Text></Box>


      </Box>
      <hr style={{ color: "grey", background: "grey", width: "90%", margin: "auto", marginTop: "20px" }} />
