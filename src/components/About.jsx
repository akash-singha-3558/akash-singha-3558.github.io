...
export const About = () => {
  ...
  return (
    ...
    <Box   boxShadow="rgb(36, 36, 58) 3px 3px 5px" borderRadius="20px" w="90%" h="100%"  display="flex" justifyContent="center" m="auto" alignItems="center" gap="15px" flexDirection={{base:"column",sm:"column",md:"column",lg:"row",xl:"row","2xl":"row"}} mt="40px">
     ...
     <Box id="user-detail-intro" w={{base:"70%",sm:"70%",md:"70%",lg:"45%",xl:"45%","2xl":"45%"}} h="50%" display="flex" justifyContent="center" alignItems="center" flexWrap={"wrap"}  flexDirection="column" gap="35px" p="25px" borderRadius="25px" >
