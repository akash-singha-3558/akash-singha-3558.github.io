...
export const About = () => {
  return (
    ...
    <Box id="about"  class="about section"  h="auto" bg="black" w="100%" backgroundColor="black" color="white" fontFamily="Roboto Mono, monospace" >
    ...
    <Box  w="90%" h="100%"  display="flex" justifyContent="center" m="auto" alignItems="center" gap="15px" flexDirection={{base:"column",sm:"column",md:"column",lg:"row",xl:"row","2xl":"row"}} mt="20px">
     <Box w={{base:"70%",sm:"70%",md:"70%",lg:"45%",xl:"45%","2xl":"45%"}} h="50%" p="15px" display="flex" justifyContent="center" alignItems="center" border="1px solid teal"  borderRadius="25px" >
